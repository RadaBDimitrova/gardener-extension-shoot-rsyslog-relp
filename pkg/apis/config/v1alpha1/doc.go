...
//go:generate gen-crd-api-reference-docs -api-dir . -config ../../../../hack/api-reference/config.json -template-dir "$TOOLS_HACK_DIR/api-reference/template" -out-file ../../../../hack/api-reference/config.md

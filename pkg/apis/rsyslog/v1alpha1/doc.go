...
//go:generate gen-crd-api-reference-docs -api-dir github.com/gardener/gardener-extension-shoot-rsyslog-relp/pkg/apis/rsyslog/v1alpha1 -config ../../../../hack/api-reference/rsyslog.json -template-dir "$TOOLS_HACK_DIR/api-reference/template" -out-file ../../../../hack/api-reference/rsyslog.md
